...
public class StumbleCarrierBeeEntity extends AppleBeeEntity {
  public StumbleCarrierBeeEntity(EntityType<? extends StumbleCarrierBeeEntity> type, World world) {
    super(type, world);
  }
  ...
  protected void registerGoals() {
    ...
    if (ConfigManager.getHoneycombDamage() > 0) {
      this.goalSelector.addGoal(1, new StumbleCarrierBeeEntity.HoneycombProjectileAttackGoal(this));
    }
  }

  static class HoneycombProjectileAttackGoal extends Goal {
    private final StumbleCarrierBeeEntity parentEntity;
    public int attackTimer;

    public HoneycombProjectileAttackGoal(StumbleCarrierBeeEntity bee) {
